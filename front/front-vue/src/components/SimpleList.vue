    ...
    <div class="list-wrap list-wrap-content" :class="{'list-adding': listAdding}" :data-order="data.order">
        ...
        <div class="list" ref="list">
            ...
            <div class="list-cards">
                ...
                <simple-card v-for="card of cards" :data="card" :key="card.id" />
            ...
            <div class="list-footer">
                <div class="list-card-add" @click="showCardAddForm">
                    <span class="icon icon-add"></span>
                    <span>添加另一张卡片</span>
                </div>
                <div class="list-add-confirm">
                    <button class="btn btn-success" @click="addNewCard">添加卡片</button>
                    <span class="icon icon-close" @click="hideCardAddForm"></span>
                </div>
            </div>
        </div>
        ...
        dragUp(e) {
            if(this.drag.isDown) {
                if(this.drag.isDrag){
                    ...
                    if(e.target === this.$refs.newBoardListName){
